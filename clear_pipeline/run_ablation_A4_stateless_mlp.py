#!/usr/bin/env python3
"""Ablation A4: Stateless MLP — no recurrent state.

Modification: LSTMCell removed and replaced by a feedforward MLP over the
attended representation. Hidden state h, c are never updated (always zeros).
Token projections, attention, and decoders are unchanged.

Run:
    cd clear_pipeline/
    python run_ablation_A4_stateless_mlp.py
"""

ABLATION_NAME = "A4_stateless_mlp"
ABLATION_DESC = "LSTMCell removed; aggregated s passed through MLP+LN instead; h/c never updated"
